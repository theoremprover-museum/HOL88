% =====================================================================
% HOL Manual LaTeX Source: latex-hol Library description
% =====================================================================

\documentstyle[makeidx,12pt,fleqn,../../../Manual/LaTeX/alltt,../../../Manual/LaTeX/layout]{book}
...
\begin{document}
   ...
   % ---------------------------------------------------------------------
   % Reference manual entries for LaTeX macros
   % ---------------------------------------------------------------------
