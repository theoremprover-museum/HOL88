...
let NEXT_THM = theorem `NEXT` `NEXT_THM`;;
...
let MULT_IMP_EXPAND = theorem `MULT_VER` `MULT_IMP_EXPAND`;;
...
let MULT_FUN_LEMMA1 = theorem `MULT_FUN` `MULT_FUN_LEMMA`;;
...
let MULT_FUN_LEMMA2  = theorem `MULT_VER` `MULT_FUN_LEMMA2`;;
let PAIR_SPLIT       = theorem `MULT_VER` `PAIR_SPLIT`;;
