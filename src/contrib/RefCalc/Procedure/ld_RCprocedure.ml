% File: ld_RCprocedure.ml
   Loads the RCprocedure theory
%

extend_theory `RCprocedure`;;
...
autoload_defs `RCprocedure`;;
autoload_thms `RCprocedure`;;
loadf `Procedure/RCprocedure_convs`;;
